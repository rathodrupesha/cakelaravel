...
{
    $key = 'ENter HEre yor Web api key XXXXXX';
    
    $url = 'https://firebasedynamiclinks.googleapis.com/v1/shortLinks?key='.$key;

    $data = array(
                  'dynamicLinkInfo' => array(
                                               'domainUriPrefix' => 'XXXhttps://app.myiqchain.netXXX',
                                               'link' => $longUrl,
...
$isi=str_replace($replacements, $entities, urlencode('XXX284815942XXX'));     //app store id
$ifl=str_replace($replacements, $entities, urlencode('XXXmyiqchain.netXXX')); //fallback id

$ibi=str_replace($replacements, $entities, urlencode('XXXcom.app.iqchainXXX'));      //bundel id
$imv=str_replace($replacements, $entities, urlencode('XXX1.0.0XXX'));                   //ios min version
$link=str_replace($replacements, $entities, urlencode('XXXhttps://www.keyocs.com?coupon_id=xxx')); //make coupon id dynamic
$apn=str_replace($replacements, $entities, urlencode('XXXcom.iqchainXXX'));     //andorid package name
$ius='';    //optional
$url='XXXhttps://app.myiqchain.net/';
$splEnd='&';
$qryStringExpression='?';
...
amv=XXX1 XXX            // android min version num
isi=XXX284815942XXX     //app store id
ifl=XXXmyiqchain.netXXX //fallback id
ibi=XXXcom.app.iqchainXXX      //bundel id
imv=XXX1.0.0XXX                   //ios min version
link=XXXhttps://www.keyocs.com?coupon_id=438
apn=XXXcom.iqchainXXX     //andorid package name
ius=    //optional
